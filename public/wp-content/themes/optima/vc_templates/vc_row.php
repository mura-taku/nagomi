...
// Column Separator
if ($column_separator_row == 'yes') {
	$separator_data = ' data-separator-color="'.(strlen($column_separator_color_row) ? $column_separator_color_row : '#eeeeee').'"';
	$css_classes[] = 'row_has_column_separator';
} else {
	$separator_data = '';
}
...
if ($full_width == '' || $full_width == 'stretch_row') {
	$output .= '<div class="container"><div class="'.esc_attr(trim( implode( ' ', array_filter( array_unique( $custom_css_classes ) )) )).'" '.$separator_data.'>';
}
